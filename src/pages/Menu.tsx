      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {beverages.map((drink, index) => <Card key={index} className="group overflow-hidden shadow-elegant transition-elegant hover:shadow-2xl">
                <div className="md:flex">
                  <div className="md:w-1/2 aspect-square md:aspect-auto overflow-hidden">
                    {drink.image ? <img src={drink.image} alt={drink.name} className="w-full h-full object-cover group-hover:scale-105 transition-elegant" /> : <div className="w-full h-full bg-muted flex items-center justify-center">
                  ...
                  <CardContent className="md:w-1/2 p-6 flex flex-col justify-center">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      {drink.featured && <Badge variant="secondary" className="text-xs">
                          Popular
                        </Badge>}
                      {drink.comingSoon && <Badge variant="outline" className="text-xs">
                          Coming Soon
                        </Badge>}
                    </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            {food.map((item, index) => <Card key={index} className="group overflow-hidden shadow-elegant transition-elegant hover:shadow-2xl">
                <div className="md:flex">
                  <div className="md:w-1/2 aspect-square md:aspect-auto overflow-hidden">
                    <img src={item.image} alt={item.name} className="w-full h-full object-cover group-hover:scale-105 transition-elegant" />
                  </div>
